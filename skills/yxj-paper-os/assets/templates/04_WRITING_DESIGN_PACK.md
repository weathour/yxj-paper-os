...
|---|---|---|---|
| Front matter / hook | 00_PROJECT_ROUTE.md#Front Matter / Hook Route Constraints; 03_WRITING_STRUCTURE.md#Front-Matter / Hook Planning Brief | 04_WRITING_DESIGN_PACK.md#Front-Matter / Hook Planning Handoff | Constraints and handoff notes only; no title/abstract/keyword/hook prose |
| Introduction / related work / citation function | 01_MATERIALS_INVENTORY.md#Citation Function and Related-Work Materials; 02_CLAIM_EVIDENCE_BOUNDARY.md#Writing-Surface Claim Boundary Matrix; 03_WRITING_STRUCTURE.md#Introduction / Related-Work Move Sequence | 04_WRITING_DESIGN_PACK.md#Introduction / Related-Work / Citation Function Handoff | Citation roles do not prove source truth or claim support without D06/D11 |
...
> D00/D02 freshness and stale flags are structural handoff checks only; they do not prove semantic adequacy, claim validity, source truth, prose quality, or visual quality.
...
| Six-track handoff matrix | Rows for all six tracks in this pack | Internal routing map, not schema |

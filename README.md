...
- Phase: Phase 9 promoted — full-stage local-paper pilot with StageContracts, PilotStageRun coverage for every canonical stage, read-only projection of `security-state-aware-mixed-platoon`, frontend Stage Coverage mode, and aggregate validation over inherited Phase 8/7/6 gates.

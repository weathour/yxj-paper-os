...
- Phase: Phase 11 promoted — Nature expert-writing skill absorption as a stage-local overlay on top of Phase 10 real-subagent-run readiness. The overlay is registry/schema/validator-backed, linked into StageContracts, strict TaskPackets, Phase10 dry-run artifacts, local-paper stage coverage, and frontend inspection without becoming a department or completion authority.

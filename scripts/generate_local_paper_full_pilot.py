...
STAGE_SOURCE_REFS = {
    ...
    "S01": ["README.md", "HANDOFF.md", "docs/CURRENT_PLAN.md", "docs/LATEST_SYNC_BRIEF.md", "paper-os/materials/current-material-index.json"],
    "S02": ["references/README.md", "references/citation-workspace-map.md", "docs/CURRENT_PLAN.md"],
    "S03": ["README.md", "HANDOFF.md", "PROJECT_STATUS.md", "manuscript/sections/01_introduction.tex"],
    "S04": ["paper-os/materials/current-material-index.json", "claims/README.md", "experiments/results/L3_method_faithful_unified_scene_20260625/manifest.json", "manuscript/sections/05_experiments.tex"],
...
def build_artifact(stage: dict[str, Any], contract: dict[str, Any], manifest: dict[str, Any], consumed: list[dict[str, str]]) -> dict[str, Any]:
    ...
    return {
        ...
        "claim_boundary_snapshot": {
            "manuscript_state": claim_boundary.get("manuscript_state"),
            "active_method": claim_boundary.get("active_method"),
            "evidence_spine": claim_boundary.get("evidence_spine") or claim_boundary.get("candidate_evidence_spine"),
            "forbidden_overclaim_boundary": claim_boundary.get("raw_safety_boundary") or claim_boundary.get("forbidden_overclaim_boundary"),
        },

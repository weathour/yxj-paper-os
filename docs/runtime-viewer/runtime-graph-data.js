window.PPG_RUNTIME_GRAPH = (() => {
  const meta = {
    ...
    subtitle: 'Phase11 本地 runtime state surface：显式物料图、stage-local Nature overlay、前沿、stale/backflow 与交付门可见',
    status: {
      baseline: 'Phase11 本地插件/runtime surface 已进入实现：adapter、stage coverage 与 Nature overlay 绑定同源',
      scope: '当前视图同时展示 stage taxonomy、Phase7 fixture-backed runtime state、Phase10 readiness 与 Phase11 stage-local overlay；仍不代表已 live-install/publish',
  ...
  const stageRunDetails = {
        ...
        "produced_artifacts": [
            {
                ...
                "payload": {
                    ...
                    "claim_boundary_snapshot": {
                        ...
                        "forbidden_overclaim_boundary": "ACC-only leads raw gap/TTC; ZT-MD-MPC wins aggregate score and is collision-free in validation suite"
                    },
    ...
    "S02": {
        ...
        "consumed_materials": [
            ...
            {
                "kind": "source_or_runtime_ref",
                "material_id": "s02_source_ref_manuscript-sections-02-related-work-tex",
                "ref": "manuscript/sections/02_related_work.tex"
            },
            {
                "kind": "source_or_runtime_ref",

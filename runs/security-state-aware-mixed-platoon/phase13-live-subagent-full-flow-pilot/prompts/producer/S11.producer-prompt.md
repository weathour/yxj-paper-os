...
Hard boundaries:
- Cite `packets/producer/S11.producer-packet.json` exactly.
...
```json
{
  ...
  "instructions": [
    "Cite this packet path exactly: packets/producer/S11.producer-packet.json",
  ...
  "output_return_ref": "returns/producer/S11.producer-return.md",
  "packet_id": "phase13.S11.producer",
  "packet_ref": "packets/producer/S11.producer-packet.json",

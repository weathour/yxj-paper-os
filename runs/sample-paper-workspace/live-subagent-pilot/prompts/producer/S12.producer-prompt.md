...
Repository: resolve from the current plugin checkout root before reading `packets/producer/S12.producer-packet.json`.
Stage: S12 — Integration and consistency pass
Packet citation: packets/producer/S12.producer-packet.json
...
Hard boundaries:
- Cite `packets/producer/S12.producer-packet.json` exactly.
...
```json
{
  ...
  "instructions": [
    "Cite this packet path exactly: packets/producer/S12.producer-packet.json",
  ...
  "output_return_ref": "returns/producer/S12.producer-return.md",
  "packet_id": "phase13.S12.producer",
  "packet_ref": "packets/producer/S12.producer-packet.json",

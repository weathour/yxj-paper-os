...
Repository: resolve from the current plugin checkout root before reading `packets/producer/S16.producer-packet.json`.
Stage: S16 — Export repository hygiene and handoff
Packet citation: packets/producer/S16.producer-packet.json
Agent type requested: git-master
...
Hard boundaries:
- Cite `packets/producer/S16.producer-packet.json` exactly.
...
```json
{
  ...
  "instructions": [
    "Cite this packet path exactly: packets/producer/S16.producer-packet.json",
  ...
  "output_return_ref": "returns/producer/S16.producer-return.md",
  "packet_id": "phase13.S16.producer",
  "packet_ref": "packets/producer/S16.producer-packet.json",

...
Repository: resolve from the current plugin checkout root before reading `packets/producer/S15.producer-packet.json`.
Stage: S15 — Repair execution and local regeneration
Packet citation: packets/producer/S15.producer-packet.json
...
Hard boundaries:
- Cite `packets/producer/S15.producer-packet.json` exactly.
...
```json
{
  ...
  "instructions": [
    "Cite this packet path exactly: packets/producer/S15.producer-packet.json",
  ...
  "output_return_ref": "returns/producer/S15.producer-return.md",
  "packet_id": "phase13.S15.producer",
  "packet_ref": "packets/producer/S15.producer-packet.json",

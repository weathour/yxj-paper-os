...
draft_id: intro_draft_invalid_authority_escape
status: candidate
section_id: intro
...
This candidate uses bounded authority wording but attempts to smuggle forbidden authority fields through front matter.

...
draft_id: intro_draft_invalid_completion
status: candidate
section_id: intro
...
graph_completion_claimed: true
recursive_dispatch_requested: false
---
# Introduction

This candidate uses bounded authority language but incorrectly claims graph completion.

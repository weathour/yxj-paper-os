...
## Corpus Check
- 86 files · ~1,101,458 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1066 nodes · 3184 edges · 57 communities detected
...
Cohesion: 0.05
Nodes (204): as_mapping(), is_non_empty_mapping_list(), is_non_empty_string(), _collect_s16_expected_manifest_hashes(), _collect_s16_required_manifest_paths(), _contains_forbidden_key(), _find_s16_narrative_overclaim(), _has_non_empty_payload_value() (+196 more)
...
Cohesion: 0.06
Nodes (61): attach_stage_coverage(), _backflow_tasks(), _base_node(), build_parser(), build_runtime_state(), _edge_source_ids(), _edge_target_ids(), main() (+53 more)
...
Cohesion: 0.17
Nodes (26): sha256_bytes(), sha256_text(), ensure_output_safe(), extract_claim_boundary(), fail(), file_fingerprint(), is_relative_to(), main() (+18 more)
...
- **Thin community `Community 38`** (2 nodes): `is_dark()`, `plot_comparison.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 39`** (2 nodes): `is_dark()`, `plot_ablation.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (2 nodes): `function()`, `plot_hole_manifold.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (2 nodes): `function()`, `plot_manifold.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 42`** (2 nodes): `plot_heatmap()`, `plot_composition.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (2 nodes): `decode_ablation()`, `plot_bars.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 44`** (2 nodes): `plot_curves()`, `plot_posttraining.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (1 nodes): `plot_brute_force.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (1 nodes): `plot_correctness_by_category.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 47`** (1 nodes): `plot_rewriting.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 48`** (1 nodes): `plot_correctness_by_subcategory.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 49`** (1 nodes): `plot_selfcorrection_math.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 50`** (1 nodes): `plot_sweep.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (1 nodes): `plot_comparison.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 52`** (1 nodes): `raw_data.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (1 nodes): `plot_comparison_Ablation.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (1 nodes): `plot_comparison_GeneRegulatory.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (1 nodes): `plot_comparison_Trajectory.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 56`** (1 nodes): `runtime-graph-data.js`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `issue()` connect `Community 0` to `Community 2`, `Community 5`, `Community 6`, `Community 9`, `Community 11`?**
  _High betweenness centrality (0.264) - this node is a cross-community bridge._
- **Why does `load_document()` connect `Community 6` to `Community 1`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 9`, `Community 10`, `Community 11`, `Community 14`, `Community 16`, `Community 17`, `Community 18`, `Community 19`, `Community 20`, `Community 21`, `Community 22`, `Community 23`, `Community 24`, `Community 25`, `Community 26`, `Community 27`, `Community 28`, `Community 29`, `Community 30`, `Community 31`?**
